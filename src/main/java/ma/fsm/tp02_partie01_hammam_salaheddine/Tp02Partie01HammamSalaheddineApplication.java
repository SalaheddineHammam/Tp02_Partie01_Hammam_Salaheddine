package ma.fsm.tp02_partie01_hammam_salaheddine;
...
public class Tp02Partie01HammamSalaheddineApplication implements CommandLineRunner {

    @Autowired
    private ProductRepository productRepository;
    public static void main(String[] args) {

        SpringApplication.run(Tp02Partie01HammamSalaheddineApplication.class, args);
    }
